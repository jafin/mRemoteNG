...
public class SequencedControl : UserControl, ISequenceChangingNotifier
{
    ...
    public event SequencedPageReplacementRequestHandler? PageReplacementRequested;
    ...
    {
        PageReplacementRequested?.Invoke(this, new SequencedPageReplacementRequestArgs(control, pagetoReplace));
    }
