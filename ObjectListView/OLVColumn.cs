...
public class OLVColumn : ColumnHeader {
    ...
    public string GroupWithItemCountFormatOrDefault {
        get {
            ...
            if (ListView != null) {
                field = ((ObjectListView)ListView).GroupWithItemCountFormatOrDefault;
                return field;
            }
    ...
    public string GroupWithItemCountSingularFormatOrDefault {
        get {
            ...
            if (ListView != null) {
                field = ((ObjectListView)ListView).GroupWithItemCountSingularFormatOrDefault;
                return field;
            }
    ...
    public bool IsButton {
        ...
        set {
            field = value;
            if (value) {
                ColumnButtonRenderer buttonRenderer = Renderer as ColumnButtonRenderer;
    ...
    public RenderDelegate RendererDelegate {
        get {
            Version1Renderer version1Renderer = Renderer as Version1Renderer;
    ...
    public string[] GetSearchValues(object rowObject) {
        ...
        DescribedTaskRenderer dtr = Renderer as DescribedTaskRenderer;
        if (dtr != null) {
            return [stringValue, dtr.GetDescription(rowObject)];
        }
    ...
    public void MakeGroupies<T>(T[] values, string[] descriptions, object[] images, string[] subtitles, string[] tasks) {
        ...
        GroupFormatter = delegate(OLVGroup group, GroupingParameters _) {
