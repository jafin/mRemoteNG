...
public partial class ObjectListView : ListView, ISupportInitialize
{
    ...
    public virtual bool CellEditTabChangesRows
    {
        ...
        set
        {
            ...
            {
                this.CellEditKeyEngine.SetKeyBehaviour(Keys.Tab, CellEditCharacterBehaviour.ChangeColumnRight,
                    CellEditAtEdgeBehaviour.ChangeRow);
                this.CellEditKeyEngine.SetKeyBehaviour(Keys.Tab | Keys.Shift,
                    CellEditCharacterBehaviour.ChangeColumnLeft, CellEditAtEdgeBehaviour.ChangeRow);
            }
            else
            {
                this.CellEditKeyEngine.SetKeyBehaviour(Keys.Tab, CellEditCharacterBehaviour.ChangeColumnRight,
                ...
                this.CellEditKeyEngine.SetKeyBehaviour(Keys.Tab | Keys.Shift,
                    CellEditCharacterBehaviour.ChangeColumnLeft, CellEditAtEdgeBehaviour.Wrap);
            }
        }
    }
    ...
    public virtual bool CellEditEnterChangesRows
    {
        ...
        set
        {
            ...
            {
                this.CellEditKeyEngine.SetKeyBehaviour(Keys.Enter, CellEditCharacterBehaviour.ChangeRowDown,
                    CellEditAtEdgeBehaviour.ChangeColumn);
                this.CellEditKeyEngine.SetKeyBehaviour(Keys.Enter | Keys.Shift, CellEditCharacterBehaviour.ChangeRowUp,
                    CellEditAtEdgeBehaviour.ChangeColumn);
            }
            else
            {
                this.CellEditKeyEngine.SetKeyBehaviour(Keys.Enter, CellEditCharacterBehaviour.EndEdit,
                    CellEditAtEdgeBehaviour.EndEdit);
                this.CellEditKeyEngine.SetKeyBehaviour(Keys.Enter | Keys.Shift, CellEditCharacterBehaviour.EndEdit,
                    CellEditAtEdgeBehaviour.EndEdit);
            }
        }
    }
...
#pragma warning restore CA2245
    ...
    public virtual IList CheckedObjects
    {
        ...
        set
        {
            ...
            Debug.WriteLine(String.Format("PERF - Setting CheckedObjects on {2} objects took {0}ms / {1} ticks",
                sw.ElapsedMilliseconds, sw.ElapsedTicks, this.GetItemCount()));
        }
    }
    ...
    {
        get { return disabledObjects.Keys; }
        set
        {
    ...
    void DropSinkCanDrop(object sender, OlvDropEventArgs e)
    {
        this.OnCanDrop(e);
    }

    void DropSinkDropped(object sender, OlvDropEventArgs e)
    {
        this.OnDropped(e);
    }

    void DropSinkModelCanDrop(object sender, ModelDropEventArgs e)
    {
        this.OnModelCanDrop(e);
    }

    void DropSinkModelDropped(object sender, ModelDropEventArgs e)
    {
...
// ReSharper disable FieldCanBeMadeReadOnly.Global
    ...
    {
        get { return this.SelectedBackColor.IsEmpty ? SystemColors.Highlight : this.SelectedBackColor; }
    }
    ...
    {
        get { return this.SelectedForeColor.IsEmpty ? SystemColors.HighlightText : this.SelectedForeColor; }
    }
    ...
    {
        get { return this.SelectedBackColorOrDefault; }
    }
    ...
    {
        get { return this.SelectedForeColorOrDefault; }
    }
    ...
    {
        get { return this.UnfocusedSelectedBackColorOrDefault; }
    }
    ...
    {
        get { return this.UnfocusedSelectedForeColorOrDefault; }
    }
...
#pragma warning restore CA2245
    ...
    {
        get { return this.BaseSmallImageList == null ? new Size(16, 16) : this.BaseSmallImageList.ImageSize; }
    }
    ...
    {
        get { return this.UnfocusedSelectedBackColor.IsEmpty ? SystemColors.Control : this.UnfocusedSelectedBackColor; }
    }
    ...
    {
        this.BuildGroups(this.PrimarySortColumn,
            this.PrimarySortOrder == SortOrder.None ? SortOrder.Ascending : this.PrimarySortOrder);
    }
...
#pragma warning restore 168
        ...
        OLVColumn sortByColumn, SortOrder sortByOrder, OLVColumn secondaryColumn, SortOrder secondaryOrder)
    {
        ...
        string titleSingularFormat =
            this.ShowItemCountOnGroups ? groupByColumn.GroupWithItemCountSingularFormatOrDefault : null;
    ...
    public virtual void BuildList(bool shouldPreserveState)
    {
        ...
        try
        {
            ...
            if (objectsToDisplay != null)
            {
                ...
                List<ListViewItem>
                    itemList = new List<ListViewItem>(); // use ListViewItem to avoid co-variant conversion
    ...
    protected OlvListViewHitTestInfo LowLevelHitTest(int x, int y)
    {
        ...
        if (headerHitTestInfo != null)
            return new OlvListViewHitTestInfo(this, headerHitTestInfo.ColumnIndex, headerHitTestInfo.IsOverCheckBox,
                headerHitTestInfo.OverDividerIndex);
        ...
        OLVListSubItem subItem =
            (this.View == View.Details && hitItem != null) ? hitItem.GetSubItem(lParam.iSubItem) : null;
        ...
        if (this.ShowGroups && this.OLVGroups != null)
        {
            if (this.VirtualMode)
            {
                group = lParam.iGroup >= 0 && lParam.iGroup < this.OLVGroups.Count
                    ? this.OLVGroups[lParam.iGroup]
                    : null;
            }
            else
            {
        ...
        OlvListViewHitTestInfo olvListViewHitTest =
            new OlvListViewHitTestInfo(hitItem, subItem, lParam.flags, group, lParam.iSubItem);
    ...
    protected virtual void CalculateStandardHitTest(OlvListViewHitTestInfo hti, int x, int y)
    {
        ...
        Size textSize = TextRenderer.MeasureText(hti.SubItem.Text, this.Font, proposedSize,
    ...
    protected virtual bool HandleBeginScroll(ref Message m)
    {
        ...
        if (nmlvscroll.dx != 0)
        {
            ...
            ScrollEventArgs args = new ScrollEventArgs(ScrollEventType.EndScroll, scrollPositionH - nmlvscroll.dx,
        ...
        if (nmlvscroll.dy != 0)
        {
            ...
            ScrollEventArgs args = new ScrollEventArgs(ScrollEventType.EndScroll, scrollPositionV - nmlvscroll.dy,
        ...
        switch (nmcustomdraw.nmcd.dwDrawStage)
        {
            ...
            case CDDS_SUBITEMPREPAINT:
                ...
                using (Graphics g = Graphics.FromHdc(nmcustomdraw.nmcd.hdc))
                {
                    ...
                    DrawListViewSubItemEventArgs args = new DrawListViewSubItemEventArgs(g, r, item, item.SubItems[0],
                        rowIndex, 0,
                    ...
                    System.Diagnostics.Trace.Assert(!args.DrawDefault,
                        "Default drawing is impossible in this situation");
                }
    ...
    protected virtual bool HandleGroupInfo(ref Message m)
    {
        ...
        const uint INTERESTING_STATES =
            (uint)(GroupState.LVGS_COLLAPSED | GroupState.LVGS_FOCUSED | GroupState.LVGS_SELECTED);
        ...
        foreach (OLVGroup group in this.OLVGroups)
        {
            ...
            {
                GroupStateChangedEventArgs args = new GroupStateChangedEventArgs(group, (GroupState)nmlvgroup.uOldState,
    ...
    protected virtual bool HandleReflectNotify(ref Message m)
    {
        ...
        switch (nmhdr.code)
        {
            ...
            case LVN_GETINFOTIP:
                ...
                NativeMethods.NMLVGETINFOTIP nmGetInfoTip =
                    (NativeMethods.NMLVGETINFOTIP)m.GetLParam(typeof(NativeMethods.NMLVGETINFOTIP));
            ...
            case LVN_ITEMCHANGED:
                ...
                NativeMethods.NMLISTVIEW nmlistviewPtr2 =
                    (NativeMethods.NMLISTVIEW)m.GetLParam(typeof(NativeMethods.NMLISTVIEW));
                        ...
                        if (isSelected)
                        {
                            ...
                            if (nmlistviewPtr2.iItem == -1 || isShiftDown)
                            {
                                ...
                                System.Diagnostics.Debug.WriteLine(String.Format(
                                    "PERF - Deselecting took {0}ms / {1} ticks", sw.ElapsedMilliseconds,
                                    sw.ElapsedTicks));
                            }
                            else
                            {
            ...
            case LVN_ITEMCHANGING:
                ...
                NativeMethods.NMLISTVIEW nmlistviewPtr =
                    (NativeMethods.NMLISTVIEW)m.GetLParam(typeof(NativeMethods.NMLISTVIEW));
    ...
    public virtual ToolStripDropDown MakeColumnCommandMenu(ToolStripDropDown strip, int columnIndex)
    {
        ...
        {
            strip.Items.Add(label, ObjectListView.SortAscendingImage,
                (EventHandler)delegate(object sender, EventArgs args) { this.Sort(column, SortOrder.Ascending); });
        }

        label = String.Format(this.MenuLabelSortDescending, column.Text);
        if (column.Sortable && !String.IsNullOrEmpty(label))
        {
            strip.Items.Add(label, ObjectListView.SortDescendingImage,
                (EventHandler)delegate(object sender, EventArgs args) { this.Sort(column, SortOrder.Descending); });
        }
        ...
        else
        {
            ...
            {
                strip.Items.Add(label, null, (EventHandler)delegate(object sender, EventArgs args) { this.Unsort(); });
            }
        }
    ...
    public virtual ToolStripDropDown MakeColumnSelectMenu(ToolStripDropDown strip)
    {
        ...
        {
            strip.Items.Add(this.MenuLabelSelectColumns, null,
                delegate(object sender, EventArgs args) { (new ColumnSelectionForm()).OpenOn(this); });
        }
    ...
    public virtual void ToggleHeaderCheckBox(OLVColumn column)
    {
        ...
        CheckState newState = CalculateToggledCheckState(column.HeaderCheckState, column.HeaderTriStateCheckBox,
            column.HeaderCheckBoxDisabled);
    ...
    private void ChangeHeaderCheckBoxState(OLVColumn column, CheckState newState)
    {
        ...
        Debug.WriteLine(String.Format("PERF - Changing row checkboxes on {2} objects took {0}ms / {1} ticks",
            sw.ElapsedMilliseconds, sw.ElapsedTicks, this.GetItemCount()));
    }
    ...
    public virtual void ToggleSubItemCheckBox(object rowObject, OLVColumn column)
    {
        ...
        SubItemCheckingEventArgs args = new SubItemCheckingEventArgs(column, this.ModelToItem(rowObject), column.Index,
    ...
    private void ApplyHyperlinkStyle(OLVListItem olvi)
    {
        for (int i = 0; i < this.Columns.Count; i++)
        {
            ...
            if (column.Hyperlink && !String.IsNullOrEmpty(subItem.Url))
                this.ApplyCellStyle(olvi, i,
                    this.IsUrlVisited(subItem.Url) ? this.HyperlinkStyle.Visited : this.HyperlinkStyle.Normal);
        }
    }
    ...
    public virtual String GetCellToolTip(int columnIndex, int rowIndex)
    {
        ...
        if (columnIndex >= 0)
        {
            ...
            if (subItem != null && !String.IsNullOrEmpty(subItem.Url) &&
                !string.Equals(subItem.Url, subItem.Text, StringComparison.Ordinal) &&
...
#pragma warning restore CA2245
    ...
    protected virtual void SetControlValue(Control control, Object value, String stringValue)
    {
        ...
        if (cb != null)
        {
            if (cb.Created)
                ...
                this.BeginInvoke(new MethodInvoker(delegate { cb.SelectedValue = value; }));
            return;
        }
    ...
    protected virtual void DrawAllDecorations(Graphics g, IList<OLVListItem> itemsThatWereRedrawn)
    {
        ...
        if (this.UseHotItem)
        {
            ...
            if (hotItemDecoration != null)
            {
                ...
                {
                    hotItemDecoration.SubItem = hotItemDecoration.ListItem == null
                        ? null
                        : hotItemDecoration.ListItem.GetSubItem(this.HotColumnIndex);
    ...
    private readonly List<GlassPanelForm>
        glassPanels = new List<GlassPanelForm>(); // The transparent panel that draws overlays

    private Dictionary<string, bool>
        visitedUrlMap = new Dictionary<string, bool>(StringComparer.Ordinal); // Which urls have been visited?
