...
Specifies whether the panel selection dialog is always shown. When set to true, initiating a connection will prompt a dialog to appear, allowing the user to choose the panel to which the connection will be added or create a new one.
