---
title: Credential Vault Connector
---

mRemote supports fetching credentials from external credential vaults. This allows providing credentials to the connection without storing sensitive information in the config file, which has numerous benefits (security, auditing, rotating passwords, etc). Three password vaults are currently supported:
...
![Credvault02](../images/credvault02.png)
...
![Credvault01](../images/credvault01.png)
...
![Credvault03](../images/credvault03.png)
...
> `op://vault-name/item-name` `op:///item-name`
