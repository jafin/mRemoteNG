---
title: Creating Bulk Connections
---
...
Since you likely don't want to spend your own time reading through XML files, we have provided an official script for doing this. You can find the most recent version [here](https://github.com/mRemoteNG/mRemoteNG/blob/develop/Tools/CreateBulkConnections_ConfCons2_6.ps1).
...
- As always, feel free to reach out to us in a [GitHub Issue](https://github.com/mRemoteNG/mRemoteNG/issues) or on [Gitter](https://gitter.im/mRemoteNG/PublicChat) if you have issues.
