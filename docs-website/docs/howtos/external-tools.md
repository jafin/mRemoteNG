...
This example will create a entry that will launch and login to server using filezilla and sftp. Start with opening up external tools from: **Tools → External Tools** And create a *New* entry. Change *Display Name* to **FileZilla** and *Filename* to **C:\Program Files\FileZilla FTP Client\filezilla.exe**. See image below:

![Example et start application 01](../images/example_et_start_application_01.png)
...
For a complete list of available variables, see the [Variables Reference](../variables-reference.md) page.
...
![Example et start application 02](../images/example_et_start_application_02.png)
...
This example will create a traceroute which you can call on for a connection to get the traceroute to the connection. Start with opening up external tools from: **Tools → External Tools** And create a *New* entry. See [External Tools](../user-interface/external-tools.md) Change *Display Name* to **Traceroute** and *Filename* to **cmd**.

See image below:

![Figure 1.0: Showing traceroute init settings](../images/example_et_traceroute_01.png)
...
![Example et traceroute 02](../images/example_et_traceroute_02.png)

This is all we really need in order to do a traceroute. Right click on a connection in the connection list and go to **External Tools → Traceroute** which will open a cmd prompt and run a tracert against the host using hostname variable.

![Example et traceroute 03](../images/example_et_traceroute_03.png)

A console like below will appear that show the traceroute and will not exit until you close the window.

![Example et traceroute 04](../images/example_et_traceroute_04.png)
...
![Example et traceroute 05](../images/example_et_traceroute_05.png)

## More examples

Please check [Common External Tool Configurations](../external-tools-cheat-sheet.md)
