...
![External Tools open with one new entryToolbar (red), Tools/Items List (blue), External Tool Properties (green)](../images/external_tools_main_ui_01.png)

*External Tools open with one new entry*

### Toolbar

![External Tools - Toolbar](../images/external_tools_toolbar_01.png)
...
![External Tools - Tools/Items list](../images/external_tools_tools_list_01.png)
...
![External Tools - External Tool Properties](../images/external_tools_external_tool_properties_01.png)
...
> `Open in FileZilla`, `FileZilla`, `Traceroute`
...
> `cmd`, `powershell`, `C:\WINDOWS\system32\compmgmt.msc`, `C:\Program Files(x86)\FileZilla FTP Client\filezilla.exe`
...
> `sftp://%USERNAME%:%PASSWORD%@%HOSTNAME%:%PORT%`, `/K tracert %HOSTNAME%`, `-NoExit tracert %HOSTNAME%`
...
For a complete list of available variables and their usage, see the [Variables Reference](../variables-reference.md) page.
...
See the [Variables Reference](../variables-reference.md) page for detailed information about:
...
See also the [Variables Reference](../variables-reference.md) page for detailed information about how to use environment variables, prevent variable expansion, rules for using variables, and special character escaping.
