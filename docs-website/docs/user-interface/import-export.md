...
![Import from Active Directory dialog](../images/import_from_active_directory.png)

*Import from Active Directory dialog*

1.  Go to: **File → Import → Import from Active Directory**
2.  Choose the domain to check for computers available
...
![Import from Port Scan dialog](../images/import_from_port_scan.png)
...
![Export to file dialog example](../images/import_export_dialog.png)
