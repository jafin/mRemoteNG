...
You can input username and hostname simultaneously when using <user@domain> as connection string. To use a custom port, append it to the hostname as hostname:port. You can combine both formats as <username@hostname>:port.
...
![Quick connect 01](../images/quick_connect_01.png)

![Quick connect 02](../images/quick_connect_02.png)

Select the appropriate network protocol by clicking the arrow next to the Connect box.

![Quick connect 03](../images/quick_connect_03.png)
...
Quick connections take most of their configuration from the [Default Connection Properties](./default-connection-properties.md). All default properties are used `except` for:
