...
![Example two panels created with Domain A and Domain B](../images/user_interface_panels_01.png)
...
![Menu items for panels under View](../images/user_interface_panels_02.png)

*Menu items for panels under **View***

Creating manual panels will make you able to organize tabs manually in mRemoteNG. To then open a connection to the new panel, right click on the connection and use **Connect (with options) → Choose panel before connecting**
...
![Right click context menu for panel](../images/user_interface_panels_03.png)
