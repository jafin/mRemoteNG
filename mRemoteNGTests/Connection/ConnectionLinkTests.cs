...
public class ConnectionLinkTests
{
    ...
    public void TestLinkSerialization()
    {
        ...
        Assert.That(xml.Contains($"LinkedConnectionId=\"{sourceConnection.ConstantID}\"", StringComparison.Ordinal), Is.True, "XML should contain LinkedConnectionId attribute");
