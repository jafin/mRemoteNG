...
internal sealed class IntegerEntryTest
{
    ...
    private static readonly int[] AllowedIntegers = [1, 2, 3];
    ...
    public void IsValid_AllowedValuesSet_ValueInAllowedValues_ReturnsTrue()
    {
        ...
        var entry = WinRegistryEntry<int>.New(TestHive, TestPath, "IsValid").SetValidation(AllowedIntegers).Read();
        Assert.That(entry.IsValid, Is.True);
    }
